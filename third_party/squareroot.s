# adapted from https://github.com/Lameguy64/PSn00bSDK/blob/master/libpsn00b/psxgte/squareroot.s
...
.section .text.SquareRoot12, "ax", @progbits
.global SquareRoot12
...
.Lsqrt12_lookup:
	...
	bltz  $t1, .Lsqrt12_result_right
	nop

	jr    $ra
	sllv  $v0, $t5, $t1

.Lsqrt12_result_right:
	subu  $t1, $zero, $t1
	jr    $ra
	srlv  $v0, $t5, $t1
...
.section .rodata.sqrt_table, "a", @progbits
.align 2
.type .Lsqrt_table, @object
.Lsqrt_table:
