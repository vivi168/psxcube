...
class Vec2:
    ...
    def pack(self):
        return struct.pack('<ii', int(self.x * ONE), int(self.y * ONE))
...
class Vec3:
    ...
    def pack(self):
        return struct.pack('<iii', int(self.x * ONE), int(self.y * ONE), int(self.z * ONE))
...
class Quaternion:
    ...
    def pack(self):
        return struct.pack('<iiii', int(self.x * ONE), int(self.y * ONE), int(self.z * ONE), int(self.w * ONE))
...
class MD5Weight:
    ...
    def pack(self):
        return struct.pack('<Ii', self.jointIndex, int(self.bias * ONE)) + self.pos.pack()
...
class MD5Mesh:
    ...
    def pack(self):
        ...
        return headerData + vertsData + trisData + weightsData + bytes(self.shader.ljust(MD5Mesh.MAX_TEX_CHAR, '\0'), 'ascii')
